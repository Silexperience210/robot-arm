...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BqWUBnEs.mjs");
...
var manifest = { "9a97e6112443cbf7e6bdcb98bccc1183b31a686930215fdb9d41e6c8c2e96e95": {
	functionName: "planArm_createServerFn_handler",
	importer: () => import("./plan-LKdVrO5s.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dv-rTiaP.mjs").then((n) => n.t),
